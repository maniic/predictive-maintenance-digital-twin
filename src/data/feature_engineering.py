...
class FeatureEngineer:
    ...
    def _compute_rolling_stats(self, group: pd.DataFrame, sensor_cols: list[str]) -> pd.DataFrame:
    ...
    def _compute_ema(self, group: pd.DataFrame, sensor_cols: list[str]) -> pd.DataFrame:
    ...
    def _compute_lags(self, group: pd.DataFrame, sensor_cols: list[str]) -> pd.DataFrame:
    ...
    def _compute_health_indicators(
        self, group: pd.DataFrame, sensor_cols: list[str]
    ) -> pd.DataFrame:
    ...
    def _compute_interactions(self, group: pd.DataFrame, sensor_cols: list[str]) -> pd.DataFrame:
